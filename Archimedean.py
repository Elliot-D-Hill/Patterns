...
class Archimedean(Pattern):
    ...
    def __init__(self, N, t, x, y, c, alpha, spiral_width, sigma):
    ...
    def archimedean_spiral(self, width):
        ...
        for i in range(self.N):
            ...
            xy_pts[i, 0] = x + (self.width) + (i * np.random.normal(0, self.sigma, 1))
            xy_pts[i, 1] = y + (self.height) + (i * np.random.normal(0, self.sigma, 1))
